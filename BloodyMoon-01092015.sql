...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-09-2015 a las 15:03:29
...
INSERT INTO `usuario` (`id`, `nomusuario`, `password`, `email`, `raza`, `FUE`, `AGI`, `INT`, `CAR`, `RES`, `sangre_rabia`, `vida`, `vida_total`, `ultima_loc`, `existe_libro`, `tiene_libro`, `historia_eric`, `tiene_eric`) VALUES
(16, 'lestat', '94069795da9215c462352301f84bec8b', 'lestat', 'Vampiro', 7, 8, 5, 7, 6, 10, 35, 25, 'palacio_noentrar', 0, 0, 0, 0);
