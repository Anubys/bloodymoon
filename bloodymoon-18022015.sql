...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-02-2015 a las 14:43:15
...
('lobo', '', 9, 9, 0, 40, ''),
('mujer_punk', 'Vaya vaya asi que el principe ha mandado a otro perrito faldero a hacerle el trabajo sucio, no se que te habra contado de todo esto, pero tu presencia no es bienvenida, tu y los malditos chupasangres de tu especie podeis largaros por donde habeis venido.\r\n\r\nLARGATE AHORA MISMO, O TE ECHO A LOS PERROS', 5, 5, 0, 25, ''),
('principe', 'Te hemos echo llamar porque necesitamos de tu ayuda, tengo un problema con un joven vampiro que adopte bajo mi mandato ahora este se ha escapado y anda liandola por la ciudad.\r\nEste vampiro nos ha causado ya innumerables problemas por lo que necesitamos que lo traigas hasta nosotros lo antes posible, vivo por supuesto.\r\nMis espias me han proporcionado un mapa de los sitios donde se le ha visto, por lo que puede ser un buen sitio por donde empezar.\r\nEs una mision importante, para la que seras ampliamente recompensado.', 0, 0, 0, 0, ''),
...
(1, 'palacio', 'Un fastuoso palacio de aspecto neo-gotico se levanta ante ti, sus muros negros como la noche y sus fuertes puertas te hacen presentir, que dentro de el se encuentra una persona importante, El principe Marcell es un gran gobernante, pero desde que perdido a su esposa hace varios años se ha vuelto una persona bastante frenetica.', 'palacio.jpg', 0),
(4, 'salon', 'Un salon inmenso se abre ante ti, la majustuosidad del mismo, te nubla la vision.\r\n\r\nDelante de ti, aparecen varias personas, impecablemente vestidas sus palidas pieles reflejan su naturaleza vampirica.\r\n\r\nMarcell se dirije hacia ti.', 'salon.jpg', 0),
(5, 'bareto', 'El purpple pig, es uno de los mejores restaurantes de chicago, cocina Europea, contemporanea,un lugar ideal, para tomar unas cerverzas y disfrutar de un buen plato de cerdo.\r\n\r\nEn el exterior no encuentras muchos rastros de vampiros, seguramente estos prefieron lugares mas elitistas y sofisticados, pero los contactos del principe dijeron que el vampiro que buscas suele frecuentar este sitio.', 'purpple.jpg', 0),
...
`id` int(11) NOT NULL,
  ...
  `ultima_loc` varchar(10) COLLATE utf8_spanish_ci NOT NULL,
  `existe_libro` tinyint(1) NOT NULL
...
INSERT INTO `usuario` (`id`, `nomusuario`, `password`, `email`, `raza`, `FUE`, `AGI`, `INT`, `CAR`, `RES`, `sangre_rabia`, `vida`, `vida_total`, `ultima_loc`, `existe_libro`) VALUES
(59, 'Rob', '25d55ad283aa400af464c76d713c07ad', 'rob@yahoo.es', 'Vampiro', 7, 8, 5, 7, 6, 4, 35, 5, 'historia', 1);
